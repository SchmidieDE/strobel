...
const Photovoltaik = () => {
    ...
    return ( 
        <>
            ...
            <Subtext variant={"white"} text={<>Bei einem optimalen Neigungswinkel von 30 bis 35 Grad bleibt in der Regel weder Laub noch Schnee auf der PV-Anlage liegen. <br/>Trotzdem sorgen Vogelkot und Umwelteinflüsse dafür, dass die Anlage gereinigt werden muss. Insbesondere der Bereich zwischen Glas und Rahmen ist anfällig für Schmutzansammlungen und das Wachstum von Moos.<br/><br/> Vernachlässigt man die regelmäßige Reinigung der Solaranlage, führt dies zu einer Verringerung des Wirkungsgrades, da weniger Sonnenlicht durch die Schmutzschicht gelangen kann.</>} />
