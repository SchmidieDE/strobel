...
const Ueberuns = () => {
    ...
    return (
        <>
            ...
            <ImageContainer alt="Bild aus Prospekt von Bruunett 678F" src={imgBruunett} priority={true}/>
            ...
            <ImageContainer src={imgRueckewagenfront} alt={"John Deere 810E Rückewagen im Wald im Einsatz"} />    
            ...
            <ImageContainer src={imgWhatsapp} alt={"MAN MKG 401 Langarmkran - Meilenstein 2023"} />    
            ...
            <Background variant="green">
                ...
                <ImageContainer src={imgTeam} alt={"John Deere 810E Rückewagen im Wald im Einsatz"} />    
