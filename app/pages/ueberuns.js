...
const Ueberuns = () => {
    ...
    return (
        <>
            ...
            <Subtext variant={"white"} text={<>Anton Strobel Senior hat 1950 begonnen traditionell mit Pferden das Holz aus dem Wald zu rücken. Dieses Familienunternehmen wurde später von Anton Strobel Junior übernommen.<br/><br/> 1988 entschied sich Peter Strobel, einen eigenständigen Weg im Bereich der Holzrückung einzuschlagen. Er revolutionierte den Betrieb, indem er den ersten in Serie produzierten Rückezug, den Bruunett 678F, einsetzte.</>}/>
            ...
            <Subtext variant={"white"} text={<>Aktuell setzen wir den John Deere 1110D Forwarder und 810E Forwarder bei der Holzrückung ein. Als Forstmaschinentransporter nutzen wir den Scania R410 LKW.</>}/>
