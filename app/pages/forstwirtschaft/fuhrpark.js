...
const Fuhrpark = () => {
    ...
    return (
        ...
        <Background variant={"green"}>
            ...
            <ImageContainer src={imgForwarder1110D} alt={"John Deere 1110D Rückewagen im Wald im Einsatz"} />    
        ...
        <ImageContainer src={imgBagger} alt={"Hitachi ZX-55U Kompaktbagger"} />
        ...
        <ImageContainer src={imgScania} alt={"Scania R410 Forstmaschinentransporter"} />
