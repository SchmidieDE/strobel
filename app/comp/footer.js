    ...
    return (
        ...
        <footer>
            ...
            <div>
                ...
                <Dropdown variant={"blue"} title="In welchen Regionen sind wir tätig?" text={<>Wir sind in ganz Oberschwaben, als auch der Bodenseeregion tätig.<br/><br/>Dazu gehört unter anderem Ulm, Biberach, Memmingen, Ravensburg, Sigmaringen, Laupheim, Kempten, Leutkirch, Wangen und kleineren Städtchen dazwischen.</>}></Dropdown>
                ...
                <Dropdown variant={"blue"} title="Wie oft muss eine PV-Anlage gereinigt werden?" text={<>Das unterscheidet sich konkret an den Umwelteinflüssen, welche Ihre Anlage ausgesetzt ist.<br/> <br/> Photovoltaikanlagen auf landwirtschaftlichen Gebäuden, insbesondere bei Tierstallungen, sind am stärksten betroffen und benötigen eine jährliche Reinigung.<br></br> <br></br>Es wird empfohlen Anlagen auf Gewerbehallen, welche durch Produktionsabgase, Maschinenstaub und umliegende Industrieaktivitäten verschmutzt werden, mindestens alle 3 Jahre zu reinigen. <br></br><br></br>Im Gegensatz dazu sind PV-Anlagen auf Wohnhäusern weniger anfällig und bedürfen nur alle 6-8 Jahre einer Reinigung.</>}></Dropdown>
                {
